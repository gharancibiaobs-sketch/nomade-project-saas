...
export default class AppErrorBoundary extends Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <main className="min-h-screen bg-[#FAF9F6] px-6 py-12 text-[#252321]">
          ...
          <pre className="mt-8 whitespace-pre-wrap border border-[#CCC5BD] p-5 font-sans text-sm text-[#252321]">
